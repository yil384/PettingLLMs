#!/bin/bash
# SFT Data Collection and Training Script for Math Environment
...
EXPERIMENT_NAME="math_sft_collection"
OUTPUT_DIR="./sft_data_math"
SFT_MODEL_OUTPUT="./sft_model_math"
...
# Run SFT data collection and training for Math environment
# Note: Update --config-name with your actual math config file
...
echo "Math SFT data collection and training completed!"
