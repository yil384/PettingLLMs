...
from pettingllms.multi_agent_env.stateful_vision.utils import (
    load_plan_path_problem_batch,
)
from pettingllms.multi_agent_env.stateful_vision.env_state import (
        ...
        *,
        ...
        for i in range(len(env_idx_list)):
            ...
            if benchmark_name in ("plan_path", "sokoban"):
                ...
                raise ValueError(f"Unsupported benchmark: {benchmark_name}. Supported: plan_path, sokoban")
